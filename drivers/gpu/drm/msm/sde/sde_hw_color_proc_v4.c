...
static unsigned short kcal_blue = 243;
static unsigned short kcal_hue = 0;
static unsigned short kcal_sat = 228;
...
module_param(kcal_hue, short, 0);
module_param(kcal_sat, short, 0644);
module_param(kcal_val, short, 0);
module_param(kcal_cont, short, 0);
